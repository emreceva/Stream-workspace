...
public class Practice {
    ...
    public static List<String> getAllEmployeesFirstName() {
        return employeeService.readAll().stream()
               .map(employee -> employee.getFirstName()) //convert stream to list
    ...
    public static List<Employee> getAllEmployeesSalaryBetween() {
       // return employeeService.readAll().stream()
         //       .filter(employee -> employee.getSalary()>1000 && employee.getSalary()<5000)
           //     .collect(Collectors.toList());
    ...
    public static List<Employee> getAllEmployeesJobIdContainsIT() {
        return employeeService.readAll().stream()
                .filter(employee -> employee.getJob().getId().equals("IT"))
                .collect(Collectors.toList());
    }
    ...
    public static Integer getLongestNameLength() throws Exception {
        return getAllEmployeesFirstName().stream()
    ...
    public static List<Employee> getAllEmployeesDepartmentIdIs90or60or100or120or130() {
        return employeeService.readAll().stream()
                ...
                .filter(employee -> employee.getDepartment().getId().equals(100L))
                .filter(employee -> employee.getDepartment().getId().equals(120L))
                .filter(employee -> employee.getDepartment().getId().equals(130L)).collect(Collectors.toList());
    }
